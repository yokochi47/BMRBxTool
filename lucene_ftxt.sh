...
java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary --freq 1

java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary.aut --freq 1\
 --field entry_author.pdbx_name --field citation_author.pdbx_name

if [ $PREFIX = "bmr" ] ; then
 java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary.pol --freq 1\
...
if [ $PREFIX = "bmr" ] ; then
 java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary.lig --freq 1\
...
if [ $PREFIX = "bmr" ] ; then
 java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary.org --freq 1\
...
java -cp extlibs/xsd2pgschema.jar luceneidx2ftxt --idx-dir $LUCENE_IDX_DIR --ftxt-dir $LUCENE_FTXT_DIR --dic dictionary.dbac --freq 1\
 --field entry.id
