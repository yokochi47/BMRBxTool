...
java -cp xsd2pgschema.jar xml2luceneidx --xsd $XSD_SCHEMA --xml $XML_RAW_DIR --idx-dir $IDX_DIR --attr-all --no-rel --no-valid --xml-file-ext-digest $FILE_EXT_DIGEST 2> $err_file
