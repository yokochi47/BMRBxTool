...
public class BMSxTool_Main {

	public final static String version = "1.35.0";
	public final static String bmrb_version = "3.2.1.18";
	...
	public static void main(String[] args) {
		...
		final String namespace_uri = "http://bmrbpub.pdbj.org/schema/" + xsd_name;

		String bmrbx_tool_home = user_home + "/Applications/bmrbx-tool-" + version; // edit this before you run

		String default_user = "bmrb";

		String url_bmrb = "jdbc:postgresql://localhost/metabolomics";
		...
		for (int i = 0; i < args.length; i++) {
			...
			if (args[i].equals("--home"))
				...
				System.out.println(" --url-bmrb  BMRB : URL of Metabolomics database. (" + url_bmrb + ")");
				System.out.println(" --user-bmrb USER : Username of Metabolomics database.");
				System.out.println(" --pass-bmrb WORD : Password of Metabolomics database.");
		...
		try {
			...
			conn_bmrb = DriverManager.getConnection(url_bmrb, user_bmrb.isEmpty() ? user : user_bmrb, password_bmrb); // metabolomics is ready.
			...
			try {
				...
				// BMSxTool_DOM.reveal(xsd_doc);

				BMSxTool_DOM.link_db(xsd_doc, conn_bmrb, password_bmrb, conn_tax, password_tax, conn_le, password_le, prefix, xsd_dir_name, src_dir_name, namespace_uri, xsd_name, file_prefix);
			...
			Logger lgr = Logger.getLogger(BMSxTool_Main.class.getName());
