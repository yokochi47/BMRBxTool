...
public class BMSxTool_Java {
	...
	public static int write(Node node, Connection conn_bmrb, String attr_name, String table_name, String dir_name, String prefix, String file_prefix) {
		...
		try {
			...
			buffw.write(BMSxTool_DOM.license);

			buffw.write("package " + BMSxTool_DOM.package_name + ";\n\n");
...
//				buffw.write("import java.math.BigInteger;\n");
			...
			if (class_name.equalsIgnoreCase(abs_class_name))
				buffw.write("import " + BMSxTool_DOM.package_name + "." + type_class_name + ".*;\n\n");
			else
				buffw.write("import " + BMSxTool_DOM.package_name + "." + type_class_name + ";\n\n");
			...
			if (class_name.equalsIgnoreCase("AtomSite") || class_name.contains("Conformer") || class_name.contains("Constr") || class_name.contains("Peak")) {
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".noatom)\n");
			...
			if (class_name.equalsIgnoreCase("HeteronuclT1Experiment") || class_name.equalsIgnoreCase("HeteronuclT1List") || class_name.equalsIgnoreCase("HeteronuclT1Software") || class_name.equalsIgnoreCase("T1"))
				buffw.write("\t\t\tif (rset.next() && " + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && !entry_id.equals(\"5505\")) {\n\n");
			// entry_id=6693, category='BMRBx:peak_general_char'
			else if (class_name.equalsIgnoreCase("PeakGeneralChar"))
				buffw.write("\t\t\tif (rset.next() && " + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && !entry_id.equals(\"6693\")) {\n\n");
			else
			...
			if (class_name.equalsIgnoreCase("ChemShiftRef")) {
				...
				buffw.write("\t\t\t\tList<" + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + "> chem_shift_ref_list = new ArrayList<" + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ">();\n\n");

				buffw.write("\t\t\t\twhile (rset.next())\n");
				buffw.write("\t\t\t\t\tchem_shift_ref_list.add(new " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + "(rset.getString(\"Atom_type\"), rset.getString(\"Atom_isotope_number\"), rset.getString(\"Indirect_shift_ratio\")));\n\n");

				buffw.write("\t\t\t\tfor (int idx_13c = 0; idx_13c < chem_shift_ref_list.size(); idx_13c++) {\n\n");

				buffw.write("\t\t\t\t\t" + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + " chem_shift_ref_13c = chem_shift_ref_list.get(idx_13c);\n\n");
				...
				buffw.write("\t\t\t\t\t\t" + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + " chem_shift_ref_15n = chem_shift_ref_list.get(idx_15n);\n\n");
				...
				buffw.write("\t\t\t\t\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && ratio_13c > 0.0 && ratio_15n > 0.0 && ratio_15n / ratio_13c > 2.3 && ratio_15n / ratio_13c < 2.7) {\n\n");
			...
			if (class_name.equals("ChemComp")) {
				...
				buffw.write("\t\t\t\t\tString bmrb_code = " + file_prefix + "_" + BMSxTool_DOM.util_chemcomp + ".checkChemCompIDwithBMRBLigandExpo(_bmrb_code, true, 0);\n");
				buffw.write("\t\t\t\t\tString pdb_code = " + file_prefix + "_" + BMSxTool_DOM.util_chemcomp + ".checkChemCompIDwithChemComp(_pdb_code, pdb_id, 0);\n\n");
			...
			// category='BMRBx:chem_shift_ref'
			if (class_name.equalsIgnoreCase("ChemShiftRef"))
				buffw.write("\t\t\t\t\t" + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + " chem_shift_ref = chem_shift_ref_list.get(i++);\n\n");
			...
			if (class_name.equalsIgnoreCase("Citation")) {
				...
				buffw.write("\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getPubMedIDByTitle(title, true, conn_bmrb, entry_id, 0);\n\n");
				...
				buffw.write("\t\t\t\t\tNode doc_sum = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n\n");

				buffw.write("\t\t\t\t\tif (doc_sum == null && !(" + empty_check("title") + ")) {\n");
				buffw.write("\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getPubMedIDByTitle(title, false, conn_bmrb, entry_id, 0);\n");
				buffw.write("\t\t\t\t\t\tdoc_sum = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n");
				...
				buffw.write("\t\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getPubMedIDByTitle(term, false, conn_bmrb, entry_id, 0);\n");
				buffw.write("\t\t\t\t\t\t\tdoc_sum = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n");
				buffw.write("\t\t\t\t\t\t\tif (doc_sum == null)\n");
				buffw.write("\t\t\t\t\t\t\t\tpubmed_id = null;\n");
				buffw.write("\t\t\t\t\t\t\telse\n");
				...
				buffw.write("\t\t\t\t\t\tdoi = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDOI(doi, doc_sum);\n");
				buffw.write("\t\t\t\t\t\tif (" + empty_check("doi") + ")\n");
				buffw.write("\t\t\t\t\t\t\tdoi = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDOIByTitle(" + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getTitle(null, doc_sum), true, conn_bmrb, entry_id, " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getYear(null, doc_sum), 0);\n");
				buffw.write("\t\t\t\t\t}\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				buffw.write("\t\t\t\t\tString ncbi_taxonomy_id = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".latestNCBITaxonomyID(conn_tax, ee.checkNCBITaxonomyID(_ncbi_taxonomy_id, entry_id, rset.getString(\"Entity_ID\"), rset.getString(\"Host_org_scientific_name\")));\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityNaturalSrc")) {
				...
				buffw.write("\t\t\t\t\tString ncbi_taxonomy_id = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".latestNCBITaxonomyID(conn_tax, en.checkNCBITaxonomyID(_ncbi_taxonomy_id, entry_id, rset.getString(\"Organism_name_scientific\")));\n\n");
			...
			if (class_name.equalsIgnoreCase("Entry")) {
				...
				buffw.write("\t\t\t\t\tlist[0].setType(Entry.Type.METABOLITE_NATURAL_PRODUCT);\n\n");
			...
			if (class_name.equalsIgnoreCase("Experiment")) {
				...
				buffw.write("\t\t\t\t\tlist[0].setNilXrayInstrumentId();\n");
				buffw.write("\t\t\t\t\tlist[0].setNilXrayInstrumentLabel();\n\n");
			...
			// entry_id=5505, category='BMRBx:heteronucl_t1_experiment', 'BMRBx:heteronucl_t1_list', 'BMRBx:heteronucl_t1_software', 'BMRBx:t1'
			if (class_name.equalsIgnoreCase("HeteronuclT1Experiment") || class_name.equalsIgnoreCase("HeteronuclT1List") || class_name.equalsIgnoreCase("HeteronuclT1Software") || class_name.equalsIgnoreCase("T1")) {
				buffw.write("\t\t\t} else if (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && entry_id.equals(\"5505\")) {\n");
			...
			// entry_id=6693, category='BMRBx:peak_general_char'
				...
				buffw.write("\t\t\t} else if (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && entry_id.equals(\"6693\")) {\n");
			...
			if ((class_name.endsWith("Experiment") || class_name.endsWith("Expt")) && (class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.startsWith("HExch") || class_name.startsWith("Heteronucl") || class_name.startsWith("Homonucl") || class_name.startsWith("OrderParameter") || class_name.startsWith("OtherData") || class_name.startsWith("PHTitration") || class_name.startsWith("SpectralDensity") || class_name.startsWith("RDC") || class_name.startsWith("SpectralDensity"))) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || val_name.equals(\"solution\")) && method_name.equalsIgnoreCase(\"setSampleState\"))\n");
				buffw.write("\t\t\tval_name = \"isotropic\";\n\n");

			}

			buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && !method_name.equalsIgnoreCase(\"setSampleState\") && (" + empty_check("val_name") + "))\n");
			buffw.write("\t\t\tval_name = \"na\";\n\n");
			...
			if (class_name.equalsIgnoreCase("Bond")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bond + ".getHECAtomID2(val_name, comp_id_1, atom_id_1, comp_id_2);\n\n");
			...
			if (class_name.equalsIgnoreCase("Citation")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && doc_sum != null) {\n");
				buffw.write("\t\t\t//if (method_name.equalsIgnoreCase(\"setDoi\"))\n");
				buffw.write("\t\t\t\t//val_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getDOI(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setTitle\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getTitle(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalNameFull\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getJournalNameFull(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalAbbrev\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getJournalAbbrev(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalVolume\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getJournalVolume(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalIssue\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getJournalIssue(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalIssn\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getJournalISSN(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setPageFirst\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getPageFirst(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setPageLast\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getPageLast(val_name, doc_sum);\n");
				buffw.write("\t\t\tif (method_name.equalsIgnoreCase(\"setYear\"))\n");
				buffw.write("\t\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getYear(val_name, doc_sum);\n");
				buffw.write("\t\t}\n\n");
			...
			if (class_name.equalsIgnoreCase("Entity")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitycompindex + ".getPolySeqOneLetterCode(conn_bmrb, entry_id, entity_id);\n\n");
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitycompindex + ".getPolySeqOneLetterCodeCan(conn_bmrb, entry_id, entity_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityNaturalSrc") || class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && !" + file_prefix + "_" + BMSxTool_DOM.util_tax + ".isValidNCBITaxonomyID(conn_tax, val_name)) {\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".getGenus(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".getSpecies(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".getOrganismCommonName(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("NaturalSourceDb")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_naturalsourcedb + ".getDatabaseCode(val_name, accession_code);\n\n");
			...
			if (class_name.equalsIgnoreCase("ChemCompAtom")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (entry_id.equals(\"bmse000098\") || entry_id.equals(\"bmse000126\") || entry_id.equals(\"bmse000180\") || entry_id.equals(\"bmse000888\") || entry_id.equals(\"bmse000978\"))) {\n\n");

				buffw.write("\t\t\tif (!(" + empty_check("val_name") + ") && val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\"))\n");
				buffw.write("\t\t\t\tval_name = val_name_can;\n\n");
			...
			if (class_name.equalsIgnoreCase("OrderParam")) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
				buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_orderparam + ".getModelFit(val_name);\n\n");
			...
			if (_integer) {
				...
				if (!( /* class_name.equalsIgnoreCase("Entry") || */ class_name.equalsIgnoreCase("Release") || class_name.equalsIgnoreCase("SgProject"))) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && !method_name.equalsIgnoreCase(\"setSampleID\") && !method_name.equalsIgnoreCase(\"setExperimentID\") && !method_name.equalsIgnoreCase(\"setStudyID\") && !method_name.equalsIgnoreCase(\"setAssemblyID\") && (method_name.contains(\"Id\") || method_name.contains(\"Number\") || method_name.contains(\"Count\")) && !method_name.contains(\"ListId\") && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
					buffw.write("\t\t\tval_name = \"0\";\n\n");

					if (class_name.equalsIgnoreCase("ConformerStatList")) {

						buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && (method_name.equalsIgnoreCase(\"setConformerCalculatedTotalNum\") || method_name.equalsIgnoreCase(\"setRepresentativeConformer\")) && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
						buffw.write("\t\t\tval_name = \"0\";\n\n");
					...
					if (class_name.equalsIgnoreCase("PhTitrationExperiment")) {
						...
						buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && (method_name.equalsIgnoreCase(\"setSampleID\") || method_name.equalsIgnoreCase(\"setExperimentID\")) && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
						buffw.write("\t\t\tval_name = \"0\";\n\n");
				...
				if (class_name.equalsIgnoreCase("EntityExperimentalSrc") || class_name.equalsIgnoreCase("EntityPurity") || class_name.equalsIgnoreCase("NMRSpectrometerView")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
				...
				if (class_name.equalsIgnoreCase("CouplingConstantExperiment") || class_name.equalsIgnoreCase("RDCExperiment") ) {
					...
					if (class_name.equalsIgnoreCase("CouplingConstantExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_couplingconstantexperiment + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, list_id);\n\n");
					if (class_name.equalsIgnoreCase("RDCExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_rdcexperiment + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, list_id);\n\n");
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getSampleID(val_name, conn_bmrb, entry_id, experiment_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("ConformerFamilyCoordSet") || class_name.equalsIgnoreCase("CouplingConstantList") || class_name.equalsIgnoreCase("OtherDataTypeList") || class_name.equalsIgnoreCase("RDCList")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getSampleConditionListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if ((class_name.endsWith("Experiment") || class_name.endsWith("Expt")) && (class_name.startsWith("ChemShift") || class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.startsWith("HExch") || class_name.startsWith("Heteronucl") || class_name.startsWith("Homonucl") || class_name.startsWith("OrderParameter") || class_name.startsWith("OtherData") || class_name.startsWith("PHTitration") || class_name.startsWith("SpectralDensity"))) {
					...
					if (class_name.equalsIgnoreCase("HExchProtectionFactExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HExchProtectionFact);\n\n");
					if (class_name.equalsIgnoreCase("HExchRateExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HExchRate);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT1Experiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT1);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT2Experiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT2);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT1RhoExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT1Rho);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclNOEExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HeteronuclNOE);\n\n");
					if (class_name.equalsIgnoreCase("HomonuclNOEExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".experiment_type.HomonuclNOE);\n\n");
					if (class_name.startsWith("ChemShift") || class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.equalsIgnoreCase("OrderParameterExperiment") || class_name.equalsIgnoreCase("PHTitrationExperiment"))
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("EntityPurity")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getSampleID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("BindingResult")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, \"\");\n\n");
				...
				if (class_name.equalsIgnoreCase("AssignedPeakChemShift")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getAssignedChemShiftListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("GenDistConstraint")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getSpectralPeakListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("Entity")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitycompindex + ".getNumberOfMonomers(conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("PDBXPolySeqScheme")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_pdbxpolyseqscheme + ".getCompIndexID(val_name, conn_bmrb, entry_id, entity_id, mon_id, pdb_seq_num);\n\n");
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_pdbxpolyseqscheme + ".getEntityAssemblyID(val_name, conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("SampleComponent")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getAssemblyID(val_name, conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("StudyEntryList") || class_name.equalsIgnoreCase("StudyKeyword")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getStudyID(val_name, conn_bmrb, entry_id, study_list_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("TheoreticalChemShiftList")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bmrb + ".getTensorListID(val_name, conn_bmrb, entry_id);\n\n");
			...
			if (has_decimal(node)) {
				...
				buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))) && (nil_method_name == null || nil_method_name.isEmpty())) {\n\n");
				...
				if (class_name.equalsIgnoreCase("AtomChemShift")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\")) || (ambiguity_code != null && ambiguity_code.equals(\"73\"))))\n");
				...
				if (class_name.equalsIgnoreCase("Entity")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml) // && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+.[0-9]{3}$\") || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_le + ".getFormulaWeight(val_name, conn_bmrb, conn_le, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("ChemComp")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml) // && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+.[0-9]{3}$\") || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))))\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_le + ".getFormulaWeight(val_name, conn_le, pdb_code);\n\n");
				...
				if (class_name.equalsIgnoreCase("OrderParam")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml)\n");
					buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_orderparam + ".getTauEVal(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("ChemCompAtom")) {
					...
					buffw.write("\t\t\tif (!(" + empty_check("val_name_can") + ") && val_name_can.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\"))\n");
					buffw.write("\t\t\t\tval_name = val_name_can;\n\n");
				...
				if (class_name.equalsIgnoreCase("PeakChar")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))))\n");
					buffw.write("\t\t\treturn false;\n\n");
			...
			if (_date) {
				...
				if (class_name.equalsIgnoreCase("Entry")) {
					...
					buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && date == null) {\n\n");

					buffw.write("\t\t\tdate = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getOriginalReleaseDate(date, conn_bmrb, entry_id);\n\n");

					buffw.write("\t\t\tif (date == null)\n");
					buffw.write("\t\t\t\tdate = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getFirstReleaseDate(date, conn_bmrb, entry_id);\n\n");
					...
					buffw.write("\t\t\t\t\t" + (class_name.equalsIgnoreCase("Entry") ? "" : ";//") + "nil_method.invoke(list);\n");
					buffw.write("\t\t\t\telse {\n");
					buffw.write("\t\t\t\t\tCalendar cal = " + file_prefix + "_" + BMSxTool_DOM.util_date + ".sqldate2calendar(date);\n");
					...
					buffw.write("\t\t\tdate = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getLastReleaseDate(date, conn_bmrb, entry_id);\n\n");
					...
					buffw.write("\t\t\tif (date == null)\n");
					buffw.write("\t\t\t\tdate = java.sql.Date.valueOf(\"1970-01-01\");\n");
				...
				try {
					...
					if (_has_enum) {
						...
						if (attr_name_lower.equals("database_code") && class_name.equalsIgnoreCase("AssemblyDbLink")) {
							buffw.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, " + file_prefix + "_" + BMSxTool_DOM.util_assemblydblink + ".checkAccessionCode(rset.getString(\"Accession_code\"), entry_id), logw, errw)) {\n");
						...
						// item='database_code', category='BMRBx:entity_db_link'
							...
							buffw.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, " + file_prefix + "_" + BMSxTool_DOM.util_entitydblink + ".checkAccessionCode(rset.getString(\"Accession_code\"), entry_id), logw, errw)) {\n");
							write_excld_log_code(buffw, method_name, column_name);
							buffw.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						// item='database_name', category='BMRBx:releated_entries'
							...
							buffw.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), conn_bmrb, entry_id, " + file_prefix + "_" + BMSxTool_DOM.util_relatedentries + ".checkDatabaseAccessionCode(rset.getString(\"Database_accession_code\"), entry_id), logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='stereo_config', category='BMRBx:chem_comp_atom'
							...
							buffw.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, rset.getString(\"Drawing_2D_coord_x\"), logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						else
							buffw.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='accession_code', category='BMRBx:assembly_db_link'
							...
							buffw.write("\t\t\t\t\tif (!set_string_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMSxTool_DOM.util_assemblydblink + ".checkAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='accession_code', category='BMRBx:entity_db_link'
							...
							buffw.write("\t\t\t\t\tif (!set_string_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMSxTool_DOM.util_entitydblink + ".checkAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='database_accession_code', category='BMRBx:related_entries'
						else if (attr_name_lower.equals("database_accession_code") && class_name.equalsIgnoreCase("RelatedEntries")) {
							buffw.write("\t\t\t\t\tif (!set_string_database_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMSxTool_DOM.util_relatedentries + ".checkDatabaseAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), entry_id, logw)) {\n");
							write_excld_log_code(buffw, method_name, column_name);
							buffw.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						...
						// item='charge', category='BMRBx:chem_comp_atom'
							...
							buffw.write("\t\t\t\t\tif (!set_string_charge(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, rset.getString(\"Drawing_2D_coord_y\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						else
							buffw.write("\t\t\t\t\tif (!set_string(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='modeled_sample_cond_list_id', category='BMRBx:chem_shifts_calc_type'
							...
							buffw.write("\t\t\t\t\tif (!set_integer_modeled_sample_cond_list_id(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), conn_bmrb, entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='tensor_list_id', category='BMRBx:theoretical_chem_shift_list'
						else if (attr_name_lower.equals("tensor_list_id") && class_name.equalsIgnoreCase("TheoreticalChemShiftList"))
							buffw.write("\t\t\t\t\tif (!set_integer_tensor_list_id(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), conn_bmrb, entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						else
						...
						// item='drawing_2d_coord_x', category='BMRBx:chem_comp_atom'
							...
							buffw.write("\t\t\t\t\tif (!set_decimal_drawing_2d_coord_xy(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, rset.getString(\"Stereo_config\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='drawing_2d_coord_y', category='BMRBx:chem_comp_atom'
							...
							buffw.write("\t\t\t\t\tif (!set_decimal_drawing_2d_coord_xy(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, rset.getString(\"Charge\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='formula_weight', category='BMRBx:entity'
						...
						// item='chem_shift_val', category='BMRBx:peak_char'
							...
							buffw.write("\t\t\t\t\tif (!set_decimal_chem_shift_val(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), logw)) {\n");
							write_excld_log_code(buffw, method_name, column_name);
							buffw.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						// item='intensity_val', category='BMRBx:peak_general_char'
						else if (attr_name_lower.equals("intensity_val") && class_name.equalsIgnoreCase("PeakGeneralChar")) {
							buffw.write("\t\t\t\t\tif (!set_decimal_intensity_val(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), logw)) {\n");
							write_excld_log_code(buffw, method_name, column_name);
							buffw.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						else
				...
				try {
					...
					if (class_name.equalsIgnoreCase("Assembly")) {
						...
						if (attr_name_lower.equals("thiol_state")) {
							...
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assembly + ".getThiolState(val_name);\n\n");
						...
						if (attr_name_lower.equals("non_standard_bonds")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assembly + ".getNonStandardBonds(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_chem_comp_sites")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assembly + ".getAmbiguousChemCompSites(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_conformational_states")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assembly + ".getAmbiguousConformationalStates(val_name);\n\n");
					...
					if (attr_name_lower.equals("database_code")) {
						...
						if (class_name.equalsIgnoreCase("AssemblyDbLink")) {
							...
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblydblink + ".getDatabaseCode(val_name, accession_code);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntityDbLink")) {
							...
							buffw.write("\t\tif (val_name != null || accession_code != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitydblink + ".getDatabaseCode(val_name, accession_code);\n\n");
					...
					if (class_name.equalsIgnoreCase("AssemblyDbLink")) {
						...
						if (attr_name_lower.equals("entry_experimental_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblydblink + ".getEntryExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("author_supplied")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblydblink + ".getAuthorSupplied(val_name);\n\n");
					...
					if (attr_name_lower.equals("mol_interaction_type") && class_name.equalsIgnoreCase("AssemblyInteraction")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblyinteraction + ".getMolInteractionType(val_name);\n\n");
					...
					if (attr_name_lower.equals("naming_system")) {
						...
						if (class_name.equalsIgnoreCase("AssemblySystematicName")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblysystematicname + ".getNamingSystem(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("ChemCompSystematicName")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompsystematicname + ".getNamingSystem(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntitySystematicName")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitysystematicname + ".getNamingSystem(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("AssemblyType")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblytype + ".getType(val_name);\n\n");

						buffw.write("\t\tif (" + empty_check("val_name") + ")\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblytype + ".getType(val_name, entry_id, assembly_id);\n\n");

						buffw.write("\t\tif (" + empty_check("val_name") + ")\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_assemblytype + ".guessType(conn_bmrb, entry_id, assembly_id);\n\n");
					...
					if (attr_name_lower.equals("temp_control_method") && class_name.equalsIgnoreCase("AutoRelaxationList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_autorelaxationlist + ".getTempControlMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Bond")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bond + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("value_order")) {
							...
							buffw.write("\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_bond + ".getValueOrder(val_name, entry_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemComp")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcomp + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("processing_site")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcomp + ".getProcessingSite(val_name);\n\n");
						...
						if (attr_name_lower.equals("paramagnetic")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcomp + ".getParamagnetic(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompAtom")) {
						...
						if (attr_name_lower.equals("aromatic_flag")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompatom + ".getAromaticFlag(val_name);\n\n");
						...
						if (attr_name_lower.equals("leaving_atom_flag")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompatom + ".getLeavingAtomFlag(val_name);\n\n");
						...
						if (attr_name_lower.equals("stereo_config")) {
							...
							buffw.write("\t\tif (entry_id.equals(\"bmse000098\") || entry_id.equals(\"bmse000126\") || entry_id.equals(\"bmse000180\") || entry_id.equals(\"bmse000888\") || entry_id.equals(\"bmse000978\")) {\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompBond")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompbond + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("value_order")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompbond + ".getValueOrder(val_name);\n\n");
						...
						if (attr_name_lower.equals("stereo_config")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompbond + ".getStereoConfig(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("ChemCompCommonName")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompcommonname + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompDescriptor")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompdescriptor + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("program")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemcompdescriptor + ".getProgram(val_name);\n\n");
					...
					if (attr_name_lower.equals("calculation_level") && class_name.equalsIgnoreCase("ChemShiftsCalcType")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftscalctype + ".getCalculationLevel(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemShiftRef")) {
						...
						if (attr_name_lower.equals("atom_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getAtomType(val_name);\n\n");
						...
						if (attr_name_lower.equals("mol_common_name")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getMolCommonName(val_name);\n\n");
						...
						if (attr_name_lower.equals("ref_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getRefMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("ref_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getRefType(val_name);\n\n");
						...
						if (attr_name_lower.equals("chem_shift_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getChemShiftUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_loc")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getExternalRefLoc(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_axis")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getExternalRefAxis(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_sample_geometry")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_chemshiftref + ".getExternalRefSampleGeometry(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Citation")) {
						...
						if (attr_name_lower.equals("class")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getClass1(val_name);\n\n");
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("status")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citation + ".getStatus(val_name);\n\n");
					...
					if (attr_name_lower.equals("family_title")) {
						...
						if (class_name.equalsIgnoreCase("CitationAuthor")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_citationauthor + ".getFamilyTitle(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntryAuthor")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entryauthor + ".getFamilyTitle(val_name);\n\n");
					...
					if (attr_name_lower.equals("refine_method") && class_name.equalsIgnoreCase("ConformerFamilyRefinement")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_conformerfamilyrefinement + ".getRefineMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ConformerStatList")) {
						...
						if (attr_name_lower.equals("conformer_selection_criteria")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_conformerstatlist + ".getConformerSelectionCriteria(val_name);\n\n");
						...
						if (attr_name_lower.equals("rep_conformer_selection_criteria")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_conformerstatlist + ".getRepConformerSelectionCriteria(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ConstraintFile")) {
						...
						if (attr_name_lower.equals("constraint_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_constraintfile + ".getConstraintType(val_name);\n\n");
						...
						if (attr_name_lower.equals("constraint_subtype")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_constraintfile + ".getConstraintSubtype(val_name);\n\n");
						...
						if (attr_name_lower.equals("constraint_subsubtype")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_constraintfile + ".getConstraintSubsubtype(val_name);\n\n");
					...
					if (attr_name_lower.equals("spectrometer_frequency_1h") && class_name.equalsIgnoreCase("CouplingConstantList")) {
						...
						buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_couplingconstantlist + ".getSpectrometerFrequency1H(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("DataSet")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_dataset + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Datum")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_datum + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Entity")) {
						...
						if (attr_name_lower.equals("polymer_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getPolymerType(val_name);\n\n");
						...
						if (attr_name_lower.equals("thiol_state")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getThiolState(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_conformational_states")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getAmbiguousConformationalStates(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_chem_comp_sites")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getAmbiguousChemCompSites(val_name);\n\n");
						...
						if (attr_name_lower.equals("nstd_chirality")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getNstdChirality(val_name);\n\n");
						...
						if (attr_name_lower.equals("nstd_linkage")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getNstdLinkage(val_name);\n\n");
						...
						if (attr_name_lower.equals("paramagnetic")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entity + ".getParamagnetic(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityAssembly")) {
						...
						if (attr_name_lower.equals("physical_state")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entityassembly + ".getPhysicalState(val_name);\n\n");
						...
						if (attr_name_lower.equals("conformational_isomer")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entityassembly + ".getConformationalIsomer(val_name);\n\n");
					...
					if (attr_name_lower.equals("value_order") && class_name.equalsIgnoreCase("EntityBond")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitybond + ".getValueOrder(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityDbLink")) {
						...
						if (attr_name_lower.equals("entry_experimental_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitydblink + ".getEntryExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("author_supplied")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entitydblink + ".getAuthorSupplied(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityNaturalSrc")) {
						...
						if (attr_name_lower.equals("superkingdom")) {
							...
							buffw.write("\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".getSuperkingdom(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
						...
						if (attr_name_lower.equals("kingdom")) {
							...
							buffw.write("\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_tax + ".getKingdom(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("Entry")) {
						...
						if (attr_name_lower.equals("experimental_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("experimental_method_subtype")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getExperimentalMethodSubtype(val_name, entry_id);\n\n");
						...
						if (attr_name_lower.equals("version_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getVersionType(val_name);\n\n");
						...
						if (attr_name_lower.equals("nmr_star_version")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getNMRStarVersion(val_name);\n\n");
						...
						if (attr_name_lower.equals("original_nmr_star_version")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entry + ".getOriginalNMRStarVersion(val_name);\n\n");
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (" + empty_check("val_name") + ")\n");
							buffw.write("\t\t\tval_name = \"metabolite/natural product\";\n\n");
					...
					if (class_name.equalsIgnoreCase("EntryExperimentalMethods")) {
						...
						if (attr_name_lower.equals("method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entryexperimentalmethods + ".getMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("subtype")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_entryexperimentalmethods + ".getSubtype(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT1List")) {
						...
						if (attr_name_lower.equals("t1_val_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt1list + ".getT1ValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t1_coherence_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt1list + ".getT1CoherenceType(val_name, entry_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT2List")) {
						...
						if (attr_name_lower.equals("t2_val_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt2list + ".getT2ValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t2_coherence_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt2list + ".getT2CoherenceType(val_name, entry_id);\n\n");
						...
						if (attr_name_lower.equals("rex_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt2list + ".getRexUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("temp_calibration_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt2list + ".getTempCalibrationMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("temp_control_method")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt2list + ".getTempControlMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT1RhoList")) {
						...
						if (attr_name_lower.equals("rex_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt1rholist + ".getRexUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t1rho_coherence_type") && class_name.equalsIgnoreCase("HeteronuclT1RhoList")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclt1rholist + ".getT1RhoCoherenceType(val_name);\n\n");
					...
					if (attr_name_lower.equals("heteronuclear_noe_val_type") && class_name.equalsIgnoreCase("HeteronuclNOEList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_heteronuclnoelist + ".getHeteronuclearNOEValType(val_name);\n\n");
					...
					if (attr_name_lower.equals("homonuclear_noe_val_type") && class_name.equalsIgnoreCase("HomonuclNOEList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_homonuclnoelist + ".getHomonuclearNOEValType(val_name);\n\n");
					...
					if (attr_name_lower.equals("val_units") && class_name.equalsIgnoreCase("HExchRateList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_hexchratelist + ".getValUnits(val_name);\n\n");
					...
					if (attr_name_lower.equals("constraint_type") && class_name.equalsIgnoreCase("GenDistConstraintList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_gendistconstraintlist + ".getConstraintType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("NMRExperimentFile")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrexperimentfile + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("NMRProbe")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrprobe + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("NMRSpecExpt")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspecexpt + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("nmr_tube_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspecexpt + ".getNMRTubeType(val_name);\n\n");
					...
					if (attr_name_lower.equals("manufacturer")) {
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometer")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspectrometer + ".getManufacturer(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerProbe")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspectrometerprobe + ".getManufacturer(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerView")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspectrometerview + ".getManufacturer(val_name);\n\n");
					...
					if (attr_name_lower.equals("field_strength")) {
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometer")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspectrometer + ".getFieldStrength(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerView")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_nmrspectrometerview + ".getFieldStrength(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("OrderParameterList")) {
						...
						if (attr_name_lower.equals("model_fit")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_orderparameterlist + ".getModelFit(val_name);\n\n");
						...
						if (attr_name_lower.equals("tau_e_val_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_orderparameterlist + ".getTauEValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("rex_val_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_orderparameterlist + ".getRexValUnits(val_name);\n\n");
					...
					if (attr_name_lower.equals("measurement_method") && class_name.equalsIgnoreCase("PeakGeneralChar")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_peakgeneralchar + ".getMeasurementMethod(val_name);\n\n");
					...
					if (attr_name_lower.equals("expt_observed_param") && class_name.equalsIgnoreCase("PHTitrationList")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_phtitrationlist + ".getExptObservedParam(val_name);\n\n");
					...
					if (attr_name_lower.equals("database_name") && class_name.equalsIgnoreCase("RelatedEntries")) {
						...
						buffw.write("\t\tif (val_name != null || accession_code != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_relatedentries + ".getDatabaseName(val_name, conn_bmrb, accession_code);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Release")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_release + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("refine_method") && class_name.equalsIgnoreCase("RepConfRefinement")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_repconfrefinement + ".getRefineMethod(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Sample")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sample + ".getType(val_name);\n\n");

						buffw.write("\t\tif (val_name != null && val_name.equals(\"gel\"))\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sample + ".getGelType(val_name, conn_bmrb, entry_id);\n\n");
					...
					if (attr_name_lower.equals("concentration_val_units") && class_name.equalsIgnoreCase("SampleComponent")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_samplecomponent + ".getConcentrationValUnits(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SampleConditionVariable")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sampleconditionvariable + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("val_units")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sampleconditionvariable + ".getValUnits(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SGProject")) {
						...
						if (attr_name_lower.equals("full_name_of_center")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sgproject + ".getFullNameOfCenter(val_name);\n\n");
						...
						if (attr_name_lower.equals("initial_of_center")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sgproject + ".getInitialOfCenter(val_name);\n\n");
						...
						if (attr_name_lower.equals("project_name")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_sgproject + ".getProjectName(val_name);\n\n");
					...
					if (attr_name_lower.equals("measurement_method") && class_name.equalsIgnoreCase("SpectralTransitionGeneralChar")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_spectraltransitiongeneralchar + ".getMeasurementMethod(val_name);\n\n");
					...
					if (attr_name_lower.equals("edge_designation") && class_name.equalsIgnoreCase("StructAnnoChar")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_structannochar + ".getEdgeDesignation(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Study")) {
						...
						buffw.write("\t\tif (val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_study + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SystematicChemShiftOffset")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_systematicchemshiftoffset + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("atom_type")) {
							...
							buffw.write("\t\tif (val_name != null)\n");
							buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_systematicchemshiftoffset + ".getAtomType(val_name);\n\n");
			...
			if (attr_name.equalsIgnoreCase(column_name)) {
				...
				try {
					...
					if (attr_name_lower.equals("ambiguity_code") && class_name.equalsIgnoreCase("AtomChemShift")) {
						...
						buffw.write("\t\tif (" + file_prefix + "_" + BMSxTool_DOM.util_main + ".remediate_xml && val_name != null)\n");
						buffw.write("\t\t\tval_name = " + file_prefix + "_" + BMSxTool_DOM.util_atomchemshift + ".getAmbiguityCode(val_name, entry_id);\n\n");
	...
	private static void write_remed_bmrb_code(BufferedWriter buffw, String method_name) throws IOException {
		...
		buffw.write("\t\t\t\t\tif (!(" + empty_check("bmrb_code") + ") && (" + empty_check("_bmrb_code") + " || !bmrb_code.equals(_bmrb_code)))\n");
	...
	private static void write_remed_pdb_code(BufferedWriter buffw, String method_name) throws IOException {
		...
		buffw.write("\t\t\t\t\tif (!(" + empty_check("pdb_code") + ") && (" + empty_check("_pdb_code") + " || !pdb_code.equals(_pdb_code)))\n");
