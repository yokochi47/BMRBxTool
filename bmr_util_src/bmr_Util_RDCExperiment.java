...
public class bmr_Util_RDCExperiment {

	public static String getExperimentID(String val_name, Connection conn_bmrb, String entry_id, String sample_id, String rdc_list_id) {
		...
		try {
			...
			if (experiments == 1)
				...
				if (experiments == 1)
					...
					String query2 = new String("select \"RDC_code\" from \"RDC\" where \"Entry_ID\"='" + entry_id + "' and \"RDC_list_ID\"='" + rdc_list_id + "' and \"ID\"='1'");

					ResultSet rset2 = state.executeQuery(query2);

					rset2.next();

					String code = rset2.getString("RDC_code");
			...
			Logger lgr = Logger.getLogger(bmr_Util_RDCExperiment.class.getName());
