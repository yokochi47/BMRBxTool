...
import org.pdbj.bmrbpub.schema.mmcifNmrStar.PeakRowFormatType.*;

public class bmr_PeakRowFormatType {

	private static final String table_name = "Peak_row_format";
	...
	public static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, FileWriter logw, FileWriter errw) {
		...
		PeakRowFormatType body = PeakRowFormatType.Factory.newInstance();
		PeakRowFormat[] list = new PeakRowFormat[1];
		...
		try {
			...
			if (rset.next()) {
				...
				buffw.write("  <BMRBx:peak_row_formatCategory>\n");
				...
				while (rset.next()) {
					...
					if (l < lines++) {
						...
						try {
							logw.write("category='PeakRowFormat', duplicated content of the category was excluded.\n");
						} catch (IOException e) {
							e.printStackTrace();
						}
					...
					list[0] = PeakRowFormat.Factory.newInstance();

					if (!set_integer(list[0], "setAmbiguityCode1", "setNilAmbiguityCode1", false, rset.getString("Ambiguity_code_1"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguityCode2", "setNilAmbiguityCode2", false, rset.getString("Ambiguity_code_2"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguityCode3", "setNilAmbiguityCode3", false, rset.getString("Ambiguity_code_3"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguityCode4", "setNilAmbiguityCode4", false, rset.getString("Ambiguity_code_4"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguityCode5", "setNilAmbiguityCode5", false, rset.getString("Ambiguity_code_5"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguitySetId1", "setNilAmbiguitySetId1", false, rset.getString("Ambiguity_set_ID_1"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguitySetId2", "setNilAmbiguitySetId2", false, rset.getString("Ambiguity_set_ID_2"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguitySetId3", "setNilAmbiguitySetId3", false, rset.getString("Ambiguity_set_ID_3"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguitySetId4", "setNilAmbiguitySetId4", false, rset.getString("Ambiguity_set_ID_4"), logw))
						continue;
					if (!set_integer(list[0], "setAmbiguitySetId5", "setNilAmbiguitySetId5", false, rset.getString("Ambiguity_set_ID_5"), logw))
						continue;
					...
					if (!set_string(list[0], "setAtomId4", "", true, rset.getString("Atom_ID_4"), logw))
						continue;
					if (!set_string(list[0], "setAtomId5", "", true, rset.getString("Atom_ID_5"), logw))
						continue;
					...
					if (!set_string(list[0], "setCompId4", "", true, rset.getString("Comp_ID_4"), logw))
						continue;
					if (!set_string(list[0], "setCompId5", "", true, rset.getString("Comp_ID_5"), logw))
						continue;
					...
					if (!set_integer(list[0], "setCompIndexId4", "", true, rset.getString("Comp_index_ID_4"), logw))
						continue;
					if (!set_integer(list[0], "setCompIndexId5", "", true, rset.getString("Comp_index_ID_5"), logw))
						continue;
					...
					if (!set_integer(list[0], "setEntityAssemblyId4", "", true, rset.getString("Entity_assembly_ID_4"), logw))
						continue;
					if (!set_integer(list[0], "setEntityAssemblyId5", "", true, rset.getString("Entity_assembly_ID_5"), logw))
						continue;
					...
					if (!set_integer(list[0], "setEntityId4", "", true, rset.getString("Entity_ID_4"), logw))
						continue;
					if (!set_integer(list[0], "setEntityId5", "", true, rset.getString("Entity_ID_5"), logw))
						continue;
					if (!set_decimal(list[0], "setFigureOfMerit", "setNilFigureOfMerit", false, rset.getString("Figure_of_merit"), logw))
						continue;
					if (!set_decimal(list[0], "setHeight", "setNilHeight", false, rset.getString("Height"), logw))
						continue;
					if (!set_decimal(list[0], "setHeightUncertainty", "setNilHeightUncertainty", false, rset.getString("Height_uncertainty"), logw))
						continue;
					if (!set_integer(list[0], "setIndexId", "", true, rset.getString("Index_ID"), logw))
						continue;
					if (!set_decimal(list[0], "setPosition1", "setNilPosition1", false, rset.getString("Position_1"), logw))
						continue;
					if (!set_decimal(list[0], "setPosition2", "setNilPosition2", false, rset.getString("Position_2"), logw))
						continue;
					if (!set_decimal(list[0], "setPosition3", "setNilPosition3", false, rset.getString("Position_3"), logw))
						continue;
					if (!set_decimal(list[0], "setPosition4", "setNilPosition4", false, rset.getString("Position_4"), logw))
						continue;
					if (!set_decimal(list[0], "setPositionUncertainty1", "setNilPositionUncertainty1", false, rset.getString("Position_uncertainty_1"), logw))
						continue;
					if (!set_decimal(list[0], "setPositionUncertainty2", "setNilPositionUncertainty2", false, rset.getString("Position_uncertainty_2"), logw))
						continue;
					if (!set_decimal(list[0], "setPositionUncertainty3", "setNilPositionUncertainty3", false, rset.getString("Position_uncertainty_3"), logw))
						continue;
					if (!set_decimal(list[0], "setPositionUncertainty4", "setNilPositionUncertainty4", false, rset.getString("Position_uncertainty_4"), logw))
						continue;
					if (!set_enum_restraint(list[0], "setRestraint", "setNilRestraint", false, rset.getString("Restraint"), logw, errw))
						continue;
					...
					if (!set_integer(list[0], "setSeqId4", "", true, rset.getString("Seq_ID_4"), logw))
						continue;
					if (!set_integer(list[0], "setSeqId5", "", true, rset.getString("Seq_ID_5"), logw))
						continue;
					if (!set_decimal(list[0], "setVolume", "setNilVolume", false, rset.getString("Volume"), logw))
						continue;
					if (!set_decimal(list[0], "setVolumeUncertainty", "setNilVolumeUncertainty", false, rset.getString("Volume_uncertainty"), logw))
						continue;
					...
					body.setPeakRowFormatArray(list);
			...
			Logger lgr = Logger.getLogger(bmr_PeakRowFormatType.class.getName());
	...
	private static boolean set_string(PeakRowFormat list, String method_name, String nil_method_name, boolean required, String val_name, FileWriter logw) {
		...
		if (!(val_name == null || val_name.isEmpty() || val_name.equals(".") || val_name.equals("?")) && (_val_name == null || _val_name.isEmpty() || _val_name.equals(".") || _val_name.equals("?") || !val_name.equals(_val_name))) {
			...
			try {
				logw.write("item='" + method_name.substring(3) + "', category='PeakRowFormat', value='" + _val_name + "' -> '" + val_name + "'\n");
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (nil && (nil_method_name == null || nil_method_name.isEmpty())) {
			...
			if (required) {
				...
				try {
					logw.write("item='" + method_name.substring(3) + "', category='PeakRowFormat', value='" + _val_name + "' was empty, but not nillable.\n");
				} catch (IOException e) {
					e.printStackTrace();
				}
	...
	private static boolean set_integer(PeakRowFormat list, String method_name, String nil_method_name, boolean required, String val_name, FileWriter logw) {
	...
	private static boolean set_decimal(PeakRowFormat list, String method_name, String nil_method_name, boolean required, String val_name, FileWriter logw) {
	...
	private static boolean set_enum_restraint(PeakRowFormat list, String method_name, String nil_method_name, boolean required, String val_name, FileWriter logw, FileWriter errw) {
		...
		try {
			Method method = _class.getMethod(method_name, new Class[]{ PeakRowFormat.Restraint.Enum.class });
			;//Method nil_method = null;
			...
			try {
				if (nil)
					...
					PeakRowFormat.Restraint.Enum _enum = PeakRowFormat.Restraint.Enum.forString(val_name);
					if (_enum != null)
						method.invoke(list, _enum);
					else {
						System.err.println("class_name:PeakRowFormat method_name:" + method_name + " val_name:" + val_name);
						for (int i = 1; i <= PeakRowFormat.Restraint.Enum.table.lastInt(); i++)
							System.err.println(" enum:" + PeakRowFormat.Restraint.Enum.forInt(i));
						try {
							errw.write("class_name:PeakRowFormat method_name:" + method_name + " val_name:" + val_name + "\n");
							for (int i = 1; i <= PeakRowFormat.Restraint.Enum.table.lastInt(); i++)
								errw.write(" enum:" + PeakRowFormat.Restraint.Enum.forInt(i) + "\n");
						} catch (IOException e) {
							e.printStackTrace();
						}
						//if (nil_method != null)
