...
java -cp extlibs/xsd2pgschema.jar luceneidx2dic --idx-dir $LUCENE_IDX_DIR --dic-dir $LUCENE_DIC_DIR --dic dictionary.aut\
 --field entry_author.pdbx_name --field citation_author.pdbx_name

if [ $PREFIX = "bmr" ] ; then
 java -cp extlibs/xsd2pgschema.jar luceneidx2dic --idx-dir $LUCENE_IDX_DIR --dic-dir $LUCENE_DIC_DIR --dic dictionary.pol\
...
if [ $PREFIX = "bmr" ] ; then
 java -cp extlibs/xsd2pgschema.jar luceneidx2dic --idx-dir $LUCENE_IDX_DIR --dic-dir $LUCENE_DIC_DIR --dic dictionary.org\
