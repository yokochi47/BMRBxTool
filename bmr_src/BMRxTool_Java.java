	...
	public static int write(Node node, Connection conn_bmrb, String attr_name, String table_name, String dir_name, String prefix, String file_prefix) {
		...
		try {
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc"))
				buffw.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entityexperimentalsrc + " ee, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, BufferedWriter logw, BufferedWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("EntityNaturalSrc"))
				buffw.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entitynaturalsrc + " en, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, BufferedWriter logw, BufferedWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("StructClassification"))
				buffw.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_structclassification + " sc, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, BufferedWriter logw, BufferedWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("Citation"))
				buffw.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_clone, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, BufferedWriter logw, BufferedWriter errw) {\n\n");
				...
				buffw.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, XmlOptions xml_opt, BufferedWriter buffw, BufferedWriter logw, BufferedWriter errw) {\n\n");
			else
			...
			if (class_name.equalsIgnoreCase("AssemblyDbLink") || class_name.equalsIgnoreCase("EntityDbLink")) {
				...
				buffw.write("\n\tprivate static boolean set_string_accession_code(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, String database_code, BufferedWriter logw) {\n\n");
			...
			if (class_name.equalsIgnoreCase("RelatedEntries")) {
				...
				buffw.write("\n\tprivate static boolean set_string_database_accession_code(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, Connection conn_bmrb, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, String database_name, BufferedWriter logw) {\n\n");
			...
			if (class_name.equalsIgnoreCase("Entry")) {
				...
				buffw.write("\n\tprivate static boolean set_string_assigned_pdb_id(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, Connection conn_bmrb, String entry_id, BufferedWriter logw) {\n\n");
				...
				buffw.write("\n\tprivate static boolean set_string_assigned_pdb_deposition_code(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, Connection conn_bmrb, String entry_id, BufferedWriter logw) {\n\n");
			...
			if (_integer) {
				...
				if (class_name.equalsIgnoreCase("StructClassification")) {
					...
					buffw.write("\n\tprivate static boolean set_integer_sunid(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String db_source_id, " + file_prefix + "_" + BMRxTool_DOM.util_structclassification + " sc, BufferedWriter logw) {\n\n");
			...
			if (attr_name.equalsIgnoreCase(column_name)) {
				...
				try {
					...
					// item='experimental_method_subtype', category='BMRBx:entry'
						...
						buffw.write("\n\t\n\t@SuppressWarnings(\"static-access\")\n\tprivate static boolean set_enum_" + attr_name_lower +"(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, BufferedWriter logw, BufferedWriter errw) {\n\n");
					// item='constraint_type', category='BMRBx:constraint_file'
					else if (attr_name_lower.equals("constraint_type") && class_name.equalsIgnoreCase("ConstraintFile"))
					...
					// item='production_method', category='BMRBx:entity_experimental_src'
						...
						buffw.write("\n\tprivate static boolean set_enum_" + attr_name_lower +"(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entityexperimentalsrc + " ee, BufferedWriter logw, BufferedWriter errw) {\n\n");
					// item='common', 'organ', 'organelle', 'secretion', 'type', category='BMRBx:entity_natural_src'
					else if ((attr_name_lower.equals("common") || attr_name_lower.equals("organ") || attr_name_lower.equals("organelle") || attr_name_lower.equals("secretion") || attr_name_lower.equals("type")) && class_name.equalsIgnoreCase("EntityNaturalSrc"))
						buffw.write("\n\tprivate static boolean set_enum_" + attr_name_lower +"(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entitynaturalsrc + " en, BufferedWriter logw, BufferedWriter errw) {\n\n");
					// item='experimental_method', 'version_type', 'nmr_star_version', 'original_nmr_star_version', category='BMRBx:entry'
					else if ((attr_name_lower.equals("experimental_method") || attr_name_lower.equals("version_type") || attr_name_lower.equals("nmr_star_version") || attr_name_lower.equals("original_nmr_star_version")) && class_name.equalsIgnoreCase("Entry"))
						buffw.write("\n\t\n\t@SuppressWarnings(\"static-access\")\n\tprivate static boolean set_enum_" + attr_name_lower +"(" + abs_class_name + " list, String method_name, String nil_method_name, boolean required, String val_name, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, BufferedWriter logw, BufferedWriter errw) {\n\n");
					else
