...
public class BMRxTool_Java {
	...
	public static int write(Node node, Connection conn_bmrb, String attr_name, String table_name, String dir_name, String prefix, String file_prefix) {
		...
		try {
			...
			filew.write(BMRxTool_DOM.license);

			filew.write("package " + BMRxTool_DOM.package_name + ";\n\n");
			...
			if (class_name.equalsIgnoreCase(abs_class_name))
				filew.write("import " + BMRxTool_DOM.package_name + "." + type_class_name + ".*;\n\n");
			else
				filew.write("import " + BMRxTool_DOM.package_name + "." + type_class_name + ";\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc"))
				filew.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entityexperimentalsrc + " ee, String entry_id, XmlOptions xml_opt, FileWriter filew, FileWriter logw, FileWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("EntityNaturalSrc"))
				filew.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entitynaturalsrc + " en, String entry_id, XmlOptions xml_opt, FileWriter filew, FileWriter logw, FileWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("StructClassification"))
				filew.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_structclassification + " sc, String entry_id, XmlOptions xml_opt, FileWriter filew, FileWriter logw, FileWriter errw) {\n\n");
			else if (class_name.equalsIgnoreCase("Citation"))
				filew.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_clone, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, XmlOptions xml_opt, FileWriter filew, FileWriter logw, FileWriter errw) {\n\n");
				...
				filew.write("\tpublic static int write_xml(Connection conn_bmrb, Connection conn_tax, Connection conn_le, " + file_prefix + "_" + BMRxTool_DOM.util_entry + " ent, String entry_id, XmlOptions xml_opt, FileWriter filew, FileWriter logw, FileWriter errw) {\n\n");
			else
			...
			if (class_name.equalsIgnoreCase("AtomSite") || class_name.contains("Conformer") || class_name.contains("Constr") || class_name.contains("Peak")) {
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".noatom)\n");
			...
			if (class_name.equalsIgnoreCase("HeteronuclT1Experiment") || class_name.equalsIgnoreCase("HeteronuclT1List") || class_name.equalsIgnoreCase("HeteronuclT1Software") || class_name.equalsIgnoreCase("T1"))
				filew.write("\t\t\tif (rset.next() && " + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && !entry_id.equals(\"5505\")) {\n\n");
			// entry_id=6693, category='BMRBx:peak_general_char'
			else if (class_name.equalsIgnoreCase("PeakGeneralChar"))
				filew.write("\t\t\tif (rset.next() && " + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && !entry_id.equals(\"6693\")) {\n\n");
			else
			...
			if (class_name.equalsIgnoreCase("ChemShiftRef")) {
				...
				filew.write("\t\t\t\tList<" + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + "> chem_shift_ref_list = new ArrayList<" + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ">();\n\n");

				filew.write("\t\t\t\twhile (rset.next())\n");
				filew.write("\t\t\t\t\tchem_shift_ref_list.add(new " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + "(rset.getString(\"Atom_type\"), rset.getString(\"Atom_isotope_number\"), rset.getString(\"Indirect_shift_ratio\")));\n\n");

				filew.write("\t\t\t\tfor (int idx_13c = 0; idx_13c < chem_shift_ref_list.size(); idx_13c++) {\n\n");

				filew.write("\t\t\t\t\t" + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + " chem_shift_ref_13c = chem_shift_ref_list.get(idx_13c);\n\n");
				...
				filew.write("\t\t\t\t\t\t" + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + " chem_shift_ref_15n = chem_shift_ref_list.get(idx_15n);\n\n");
				...
				filew.write("\t\t\t\t\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && ratio_13c > 0.0 && ratio_15n > 0.0 && ratio_15n / ratio_13c > 2.3 && ratio_15n / ratio_13c < 2.7) {\n\n");
			...
			if (class_name.equals("ChemComp")) {
				...
				filew.write("\t\t\t\t\tString bmrb_code = " + file_prefix + "_" + BMRxTool_DOM.util_chemcomp + ".checkChemCompIDwithBMRBLigandExpo(_bmrb_code, true, 0);\n");
				filew.write("\t\t\t\t\tString pdb_code = " + file_prefix + "_" + BMRxTool_DOM.util_chemcomp + ".checkChemCompIDwithChemComp(_pdb_code, pdb_id, 0);\n\n");
			...
			// category='BMRBx:chem_shift_ref'
			if (class_name.equalsIgnoreCase("ChemShiftRef"))
				filew.write("\t\t\t\t\t" + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + " chem_shift_ref = chem_shift_ref_list.get(i++);\n\n");
			...
			if (class_name.equalsIgnoreCase("Citation")) {
				...
				filew.write("\t\t\t\t\tif (" + empty_check("pubmed_id") + " || pubmed_id.matches(\"^[0-9]$\") || pubmed_id.matches(\"^[A-Za-z].*\"))\n");
				filew.write("\t\t\t\t\t\tpubmed_id = ent.getPrimaryPubMedIDViaPDB(pubmed_id, conn_bmrb, entry_id);\n\n");

				filew.write("\t\t\t\t\tif ((" + empty_check("pubmed_id") + " || pubmed_id.matches(\"^[0-9]$\") || pubmed_id.matches(\"^[A-Za-z].*\")) && !(" + empty_check("title") + "))\n");
				filew.write("\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getPubMedIDByTitle(title, true, conn_bmrb, entry_id, 0);\n\n");
				...
				filew.write("\t\t\t\t\tNode doc_sum = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n\n");

				filew.write("\t\t\t\t\tif (doc_sum == null && !(" + empty_check("title") + ")) {\n");
				filew.write("\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getPubMedIDByTitle(title, false, conn_bmrb, entry_id, 0);\n");
				filew.write("\t\t\t\t\t\tdoc_sum = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n");
				...
				filew.write("\t\t\t\t\t\t\tpubmed_id = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getPubMedIDByTitle(term, false, conn_bmrb, entry_id, 0);\n");
				filew.write("\t\t\t\t\t\t\tdoc_sum = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDocSumNodeByPubMedID(pubmed_id, 0);\n");
				filew.write("\t\t\t\t\t\t\tif (doc_sum == null)\n");
				filew.write("\t\t\t\t\t\t\t\tpubmed_id = null;\n");
				filew.write("\t\t\t\t\t\t\telse\n");
				...
				filew.write("\t\t\t\t\t\tdoi = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDOI(doi, doc_sum);\n");
				filew.write("\t\t\t\t\t\tif (" + empty_check("doi") + ")\n");
				filew.write("\t\t\t\t\t\t\tdoi = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDOIByTitle(" + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getTitle(null, doc_sum), true, conn_bmrb, entry_id, " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getYear(null, doc_sum), 0);\n");
				filew.write("\t\t\t\t\t}\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				filew.write("\t\t\t\t\tString host_org_scientific_name = rset.getString(\"Host_org_scientific_name\");\n");
				filew.write("\t\t\t\t\tString production_method = rset.getString(\"Production_method\");\n\n");

				filew.write("\t\t\t\t\tString _ncbi_taxonomy_id = rset.getString(\"Host_org_NCBI_taxonomy_ID\");\n");
				filew.write("\t\t\t\t\tString ncbi_taxonomy_id = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".latestNCBITaxonomyID(conn_tax, ee.checkNCBITaxonomyID(_ncbi_taxonomy_id, entry_id, rset.getString(\"Entity_ID\"), host_org_scientific_name, production_method));\n\n");

				filew.write("\t\t\t\t\tif ((" + empty_check("ncbi_taxonomy_id") + " || ncbi_taxonomy_id.equals(\"na\")) && !(" + empty_check("host_org_scientific_name") + " || host_org_scientific_name.equals(\"na\")) && !(" + empty_check("production_method")+ " || production_method.contains(\"synthesis\") || production_method.contains(\"obtained\")))\n");
				filew.write("\t\t\t\t\t\tncbi_taxonomy_id = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getNCBITaxonomyID(conn_tax, ncbi_taxonomy_id, host_org_scientific_name);\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityNaturalSrc")) {
				...
				filew.write("\t\t\t\t\tString ncbi_taxonomy_id = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".latestNCBITaxonomyID(conn_tax, en.checkNCBITaxonomyID(_ncbi_taxonomy_id, entry_id, rset.getString(\"Organism_name_scientific\")));\n\n");
			...
			if (class_name.equalsIgnoreCase("StructClassification"))
				filew.write("\t\t\t\t\tset_integer_sunid(list[0], \"setSunid\", \"setNilSunid\", false, rset.getString(\"DB_source_ID\"), sc, logw);\n");
			...
			// entry_id=5505, category='BMRBx:heteronucl_t1_experiment', 'BMRBx:heteronucl_t1_list', 'BMRBx:heteronucl_t1_software', 'BMRBx:t1'
			if (class_name.equalsIgnoreCase("HeteronuclT1Experiment") || class_name.equalsIgnoreCase("HeteronuclT1List") || class_name.equalsIgnoreCase("HeteronuclT1Software") || class_name.equalsIgnoreCase("T1")) {
				filew.write("\t\t\t} else if (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && entry_id.equals(\"5505\")) {\n");
			...
			// entry_id=6693, category='BMRBx:peak_general_char'
				...
				filew.write("\t\t\t} else if (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && entry_id.equals(\"6693\")) {\n");
			...
			filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml) {\n\n");
			...
			if ((class_name.endsWith("Experiment") || class_name.endsWith("Expt")) && (class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.startsWith("HExch") || class_name.startsWith("Heteronucl") || class_name.startsWith("Homonucl") || class_name.startsWith("OrderParameter") || class_name.startsWith("OtherData") || class_name.startsWith("PHTitration") || class_name.startsWith("SpectralDensity") || class_name.startsWith("RDC") || class_name.startsWith("SpectralDensity"))) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || val_name.equals(\"solution\")) && method_name.equalsIgnoreCase(\"setSampleState\"))\n");
				filew.write("\t\t\tval_name = \"isotropic\";\n\n");

			}

			filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && !method_name.equalsIgnoreCase(\"setSampleState\") && (" + empty_check("val_name") + "))\n");
			filew.write("\t\t\tval_name = \"na\";\n\n");
			...
			if (class_name.equalsIgnoreCase("Bond")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bond + ".getHECAtomID2(val_name, comp_id_1, atom_id_1, comp_id_2);\n\n");
			...
			if (class_name.equalsIgnoreCase("ChemComp")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
			...
			if (class_name.equalsIgnoreCase("Citation")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && doc_sum != null) {\n");
				filew.write("\t\t\t//if (method_name.equalsIgnoreCase(\"setDoi\"))\n");
				filew.write("\t\t\t\t//val_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getDOI(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setTitle\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getTitle(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalNameFull\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getJournalNameFull(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalAbbrev\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getJournalAbbrev(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalVolume\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getJournalVolume(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalIssue\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getJournalIssue(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setJournalIssn\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getJournalISSN(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setPageFirst\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getPageFirst(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setPageLast\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getPageLast(val_name, doc_sum);\n");
				filew.write("\t\t\tif (method_name.equalsIgnoreCase(\"setYear\"))\n");
				filew.write("\t\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getYear(val_name, doc_sum);\n");
				filew.write("\t\t}\n\n");
			...
			if (class_name.equalsIgnoreCase("Assembly") || class_name.equalsIgnoreCase("Entity")) {
				...
				if (class_name.equalsIgnoreCase("Assembly"))
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assembly + ".checkECNumber(val_name, entry_id);\n\n");
				else
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".checkECNumber(val_name, entry_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("AssemblyDbLink") || class_name.equalsIgnoreCase("EntityDbLink")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("database_code") + "))\n");
				if (class_name.equalsIgnoreCase("AssemblyDbLink"))
					filew.write("\t\t\tdatabase_code = " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".getDatabaseCode(database_code, val_name);\n\n");
				else
					filew.write("\t\t\tdatabase_code = " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".getDatabaseCode(database_code, val_name);\n\n");

				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && database_code != null && database_code.equals(\"PDB\"))\n");
				filew.write("\t\t\tval_name = ent.getEffectivePDBID(val_name);\n\n");
			...
			if (class_name.equalsIgnoreCase("Entity")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitycompindex + ".getPolySeqOneLetterCode(conn_bmrb, entry_id, entity_id);\n\n");
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitycompindex + ".getPolySeqOneLetterCodeCan(conn_bmrb, entry_id, entity_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityNaturalSrc") || class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && !" + file_prefix + "_" + BMRxTool_DOM.util_tax + ".isValidNCBITaxonomyID(conn_tax, val_name)) {\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityExperimentalSrc")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getGenus(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getSpecies(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getOrganismCommonName(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("EntityNaturalSrc")) {
				...
				filew.write("\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getOrganismScientificName(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("NaturalSourceDb")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_naturalsourcedb + ".getDatabaseCode(val_name, accession_code);\n\n");
			...
			if (class_name.equalsIgnoreCase("RelatedEntries")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("database_name") + "))\n");
				filew.write("\t\t\tdatabase_name = " + file_prefix + "_" + BMRxTool_DOM.util_relatedentries + ".getDatabaseName(database_name, conn_bmrb, val_name);\n");

				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && database_name != null && database_name.equals(\"PDB\"))\n");
				filew.write("\t\t\tval_name = ent.getEffectivePDBID(val_name);\n\n");
			...
			if (class_name.equalsIgnoreCase("Entry")) {
				...
				filew.write("\t\t\tval_name = ent.getAssignedPDBID(val_name, conn_bmrb, entry_id);\n\n");
				...
				write_invoke_string_method_with_nil(filew);
				...
				filew.write("\t\t\tval_name = ent.getAssignedPDBDepositionCode(val_name, conn_bmrb, entry_id);\n\n");
			...
			if (class_name.equalsIgnoreCase("OrderParam")) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
				filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_orderparam + ".getModelFit(val_name);\n\n");
			...
			if (_integer) {
				...
				if (!(/* class_name.equalsIgnoreCase("Entry") || */ class_name.equalsIgnoreCase("Release") || class_name.equalsIgnoreCase("SgProject"))) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && !method_name.equalsIgnoreCase(\"setSampleID\") && !method_name.equalsIgnoreCase(\"setExperimentID\") && !method_name.equalsIgnoreCase(\"setStudyID\") && !method_name.equalsIgnoreCase(\"setAssemblyID\") && (method_name.contains(\"Id\") || method_name.contains(\"Number\") || method_name.contains(\"Count\")) && !method_name.contains(\"ListId\") && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
					filew.write("\t\t\tval_name = \"0\";\n\n");

					if (class_name.equalsIgnoreCase("ConformerStatList")) {

						filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && (method_name.equalsIgnoreCase(\"setConformerCalculatedTotalNum\") || method_name.equalsIgnoreCase(\"setRepresentativeConformer\")) && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
						filew.write("\t\t\tval_name = \"0\";\n\n");
					...
					if (class_name.equalsIgnoreCase("PhTitrationExperiment")) {
						...
						filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (nil_method_name == null || nil_method_name.isEmpty()) && (method_name.equalsIgnoreCase(\"setSampleID\") || method_name.equalsIgnoreCase(\"setExperimentID\")) && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
						filew.write("\t\t\tval_name = \"0\";\n\n");
				...
				if (class_name.equalsIgnoreCase("EntityDeletedAtom") || class_name.equalsIgnoreCase("EntityExperimentalSrc") || class_name.equalsIgnoreCase("EntityPurity") || class_name.equalsIgnoreCase("NMRSpectrometerView")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+$\")))\n");
				...
				if (class_name.equalsIgnoreCase("StructClassification")) {
					...
					filew.write("\t\tString val_name = \"\";\n");
					filew.write("\t\tString _val_name = \"\";\n\n");

					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && !(" + empty_check("db_source_id") + "))\n");
					filew.write("\t\t\tval_name = sc.getSunIDByKey(db_source_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("CouplingConstantExperiment") || class_name.equalsIgnoreCase("RDCExperiment") ) {
					...
					if (class_name.equalsIgnoreCase("CouplingConstantExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_couplingconstantexperiment + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, list_id);\n\n");
					if (class_name.equalsIgnoreCase("RDCExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_rdcexperiment + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, list_id);\n\n");
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getSampleID(val_name, conn_bmrb, entry_id, experiment_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("ConformerFamilyCoordSet") || class_name.equalsIgnoreCase("CouplingConstantList") || class_name.equalsIgnoreCase("OtherDataTypeList") || class_name.equalsIgnoreCase("RDCList")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getSampleConditionListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if ((class_name.endsWith("Experiment") || class_name.endsWith("Expt")) && (class_name.startsWith("ChemShift") || class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.startsWith("HExch") || class_name.startsWith("Heteronucl") || class_name.startsWith("Homonucl") || class_name.startsWith("OrderParameter") || class_name.startsWith("OtherData") || class_name.startsWith("PHTitration") || class_name.startsWith("SpectralDensity"))) {
					...
					if (class_name.equalsIgnoreCase("HExchProtectionFactExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HExchProtectionFact);\n\n");
					if (class_name.equalsIgnoreCase("HExchRateExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HExchRate);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT1Experiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT1);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT2Experiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT2);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclT1RhoExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HeteronuclT1Rho);\n\n");
					if (class_name.equalsIgnoreCase("HeteronuclNOEExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HeteronuclNOE);\n\n");
					if (class_name.equalsIgnoreCase("HomonuclNOEExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id, " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".experiment_type.HomonuclNOE);\n\n");
					if (class_name.startsWith("ChemShift") || class_name.startsWith("ConformerFamilyCoordSet") || class_name.startsWith("CrossCorrelation") || class_name.equalsIgnoreCase("OrderParameterExperiment") || class_name.equalsIgnoreCase("PHTitrationExperiment"))
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, sample_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("EntityPurity")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getSampleID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("BindingResult")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getExperimentID(val_name, conn_bmrb, entry_id, \"\");\n\n");
				...
				if (class_name.equalsIgnoreCase("AssignedPeakChemShift")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getAssignedChemShiftListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("Entity")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitycompindex + ".getNumberOfMonomers(conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("GenDistConstraint")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getSpectralPeakListID(val_name, conn_bmrb, entry_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("PDBXPolySeqScheme")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_pdbxpolyseqscheme + ".getCompIndexID(val_name, conn_bmrb, entry_id, entity_id, mon_id, pdb_seq_num);\n\n");
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_pdbxpolyseqscheme + ".getEntityAssemblyID(val_name, conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("SampleComponent")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getAssemblyID(val_name, conn_bmrb, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("StudyEntryList") || class_name.equalsIgnoreCase("StudyKeyword")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + "))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bmrb + ".getStudyID(val_name, conn_bmrb, entry_id, study_list_id);\n\n");
			...
			if (has_decimal(node)) {
				...
				filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))) && (nil_method_name == null || nil_method_name.isEmpty())) {\n\n");
				...
				if (class_name.equalsIgnoreCase("AtomChemShift")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && (" + empty_check("val_name") + " || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\")) || (ambiguity_code != null && ambiguity_code.equals(\"73\"))))\n");
				...
				if (class_name.equalsIgnoreCase("Entity")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml) // && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+.[0-9]{3}$\") || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_le + ".getFormulaWeight(val_name, conn_bmrb, conn_le, entry_id, entity_id);\n\n");
				...
				if (class_name.equalsIgnoreCase("ChemComp")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml) // && (" + empty_check("val_name") + " || !val_name.matches(\"^[-+]?[0-9]+.[0-9]{3}$\") || (!val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)?$\") && !val_name.matches(\"^[-+]?([0-9]+(\\\\.[0-9]*)?|\\\\.[0-9]+)([eE][-+]?[0-9]+)?$\"))))\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_le + ".getFormulaWeight(val_name, conn_le, pdb_code);\n\n");
				...
				if (class_name.equalsIgnoreCase("OrderParam")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml)\n");
					filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_orderparam + ".getTauEVal(val_name, conn_bmrb, entry_id);\n\n");
			...
			if (_date) {
				...
				if (class_name.equalsIgnoreCase("Entry")) {
					...
					filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && date == null) {\n\n");

					filew.write("\t\t\tdate = " + file_prefix + "_" + BMRxTool_DOM.util_entry + ".getOriginalReleaseDate(date, conn_bmrb, entry_id);\n\n");

					filew.write("\t\t\tif (date == null)\n");
					filew.write("\t\t\t\tdate = " + file_prefix + "_" + BMRxTool_DOM.util_entry + ".getFirstReleaseDate(date, conn_bmrb, entry_id);\n\n");
					...
					filew.write("\t\t\tdate = " + file_prefix + "_" + BMRxTool_DOM.util_entry + ".getLastReleaseDate(date, conn_bmrb, entry_id);\n\n");
				...
				try {
					...
					if (_has_enum) {
						...
						if (attr_name_lower.equals("database_code") && class_name.equalsIgnoreCase("AssemblyDbLink")) {
							filew.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".checkAccessionCode(rset.getString(\"Accession_code\"), entry_id), logw, errw)) {\n");
						...
						// item='database_code', category='BMRBx:entity_db_link'
							...
							filew.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), entry_id, " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".checkAccessionCode(rset.getString(\"Accession_code\"), entry_id), logw, errw)) {\n");
							write_excld_log_code(filew, method_name, column_name);
							filew.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						// item='database_name', category='BMRBx:releated_entries'
							...
							filew.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), conn_bmrb, entry_id, " + file_prefix + "_" + BMRxTool_DOM.util_relatedentries + ".checkDatabaseAccessionCode(rset.getString(\"Database_accession_code\"), entry_id), logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='experimental_method_subtype', category='BMRBx:entry'
							...
							filew.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), ent, entry_id, logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='experimental_method', 'version_type', 'nmr_star_version', 'original_nmr_star_version', category='BMRBx:entry'
							...
							filew.write("\t\t\t\t\tif (!set_enum_" + attr_name_lower +"(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), ent, logw, errw))\n\t\t\t\t\t\tcontinue;\n");
						...
						// item='accession_code', category='BMRBx:assembly_db_link'
							...
							filew.write("\t\t\t\t\tif (!set_string_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".checkAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), ent, entry_id, rset.getString(\"Database_code\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='accession_code', category='BMRBx:entity_db_link'
							...
							filew.write("\t\t\t\t\tif (!set_string_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".checkAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), ent, entry_id, rset.getString(\"Database_code\"), logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='database_accession_code', category='BMRBx:related_entries'
						else if (attr_name_lower.equals("database_accession_code") && class_name.equalsIgnoreCase("RelatedEntries")) {
							filew.write("\t\t\t\t\tif (!set_string_database_accession_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", " + file_prefix + "_" + BMRxTool_DOM.util_relatedentries + ".checkDatabaseAccessionCode(rset.getString(\"" + column_name + "\"), entry_id), conn_bmrb, ent, entry_id, rset.getString(\"Database_name\"), logw)) {\n");
							write_excld_log_code(filew, method_name, column_name);
							filew.write("\t\t\t\t\t\tcontinue;\n\t\t\t\t\t}\n");
						}
						...
						// item='assigned_pdb_id', category='BMRBx:entry'
							...
							filew.write("\t\t\t\t\tif (!set_string_assigned_pdb_id(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), ent, conn_bmrb, entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						// item='assigned_pdb_deposition_code', category='BMRBx:entry'
							...
							filew.write("\t\t\t\t\tif (!set_string_assigned_pdb_deposition_code(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), ent, conn_bmrb, entry_id, logw))\n\t\t\t\t\t\tcontinue;\n");
						else
							filew.write("\t\t\t\t\tif (!set_string(list[0], \"" + method_name + "\", \"" + nil_method_name + "\", " + required + ", rset.getString(\"" + column_name + "\"), logw))\n\t\t\t\t\t\tcontinue;\n");
				...
				try {
					...
					if (class_name.equalsIgnoreCase("Assembly")) {
						...
						if (attr_name_lower.equals("thiol_state")) {
							...
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assembly + ".getThiolState(val_name);\n\n");
						...
						if (attr_name_lower.equals("non_standard_bonds")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assembly + ".getNonStandardBonds(val_name);\n\n");
					...
					if (attr_name_lower.equals("database_code")) {
						...
						if (class_name.equalsIgnoreCase("AssemblyDbLink")) {
							...
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".getDatabaseCode(val_name, accession_code);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntityDbLink")) {
							...
							filew.write("\t\tif (val_name != null || accession_code != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".getDatabaseCode(val_name, accession_code);\n\n");
					...
					if (class_name.equalsIgnoreCase("AssemblyDbLink")) {
						...
						if (attr_name_lower.equals("entry_experimental_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".getEntryExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("author_supplied")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblydblink + ".getAuthorSupplied(val_name);\n\n");
					...
					if (attr_name_lower.equals("mol_interaction_type") && class_name.equalsIgnoreCase("AssemblyInteraction")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblyinteraction + ".getMolInteractionType(val_name);\n\n");
					...
					if (attr_name_lower.equals("naming_system")) {
						...
						if (class_name.equalsIgnoreCase("AssemblySystematicName")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblysystematicname + ".getNamingSystem(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("ChemCompSystematicName")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompsystematicname + ".getNamingSystem(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntitySystematicName")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitysystematicname + ".getNamingSystem(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("AssemblyType")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblytype + ".getType(val_name);\n\n");

						filew.write("\t\tif (" + empty_check("val_name") + ")\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblytype + ".getType(val_name, entry_id, assembly_id);\n\n");

						filew.write("\t\tif (" + empty_check("val_name") + ")\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_assemblytype + ".guessType(conn_bmrb, entry_id, assembly_id);\n\n");
					...
					if (attr_name_lower.equals("temp_control_method") && class_name.equalsIgnoreCase("AutoRelaxationList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_autorelaxationlist + ".getTempControlMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Bond")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bond + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("value_order")) {
							...
							filew.write("\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_bond + ".getValueOrder(val_name, entry_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemComp")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcomp + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("processing_site")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcomp + ".getProcessingSite(val_name);\n\n");
						...
						if (attr_name_lower.equals("paramagnetic")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcomp + ".getParamagnetic(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompAtom")) {
						...
						if (attr_name_lower.equals("aromatic_flag")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompatom + ".getAromaticFlag(val_name);\n\n");
						...
						if (attr_name_lower.equals("leaving_atom_flag")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompatom + ".getLeavingAtomFlag(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompBond")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompbond + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("value_order")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompbond + ".getValueOrder(val_name);\n\n");
						...
						if (attr_name_lower.equals("stereo_config")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompbond + ".getStereoConfig(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("ChemCompCommonName")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompcommonname + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemCompDescriptor")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompdescriptor + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("program")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompdescriptor + ".getProgram(val_name);\n\n");
					...
					if (attr_name_lower.equals("program") && class_name.equalsIgnoreCase("ChemCompIdentifier")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemcompidentifier + ".getProgram(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ChemShiftRef")) {
						...
						if (attr_name_lower.equals("mol_common_name")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getMolCommonName(val_name);\n\n");
						...
						if (attr_name_lower.equals("ref_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getRefMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("ref_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getRefType(val_name);\n\n");
						...
						if (attr_name_lower.equals("chem_shift_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getChemShiftUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_loc")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getExternalRefLoc(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_axis")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getExternalRefAxis(val_name);\n\n");
						...
						if (attr_name_lower.equals("external_ref_sample_geometry")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_chemshiftref + ".getExternalRefSampleGeometry(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Citation")) {
						...
						if (attr_name_lower.equals("class")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getClass1(val_name);\n\n");
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("status")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citation + ".getStatus(val_name);\n\n");
					...
					if (attr_name_lower.equals("family_title")) {
						...
						if (class_name.equalsIgnoreCase("CitationAuthor")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_citationauthor + ".getFamilyTitle(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("EntryAuthor")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entryauthor + ".getFamilyTitle(val_name);\n\n");
					...
					if (attr_name_lower.equals("refine_method") && class_name.equalsIgnoreCase("ConformerFamilyRefinement")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_conformerfamilyrefinement + ".getRefineMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ConformerStatList")) {
						...
						if (attr_name_lower.equals("conformer_selection_criteria")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_conformerstatlist + ".getConformerSelectionCriteria(val_name);\n\n");
						...
						if (attr_name_lower.equals("rep_conformer_selection_criteria")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_conformerstatlist + ".getRepConformerSelectionCriteria(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("ConstraintFile")) {
						...
						if (attr_name_lower.equals("constraint_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_constraintfile + ".getConstraintType(val_name);\n\n");
						...
						if (attr_name_lower.equals("constraint_subtype")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_constraintfile + ".getConstraintSubtype(val_name);\n\n");
						...
						if (attr_name_lower.equals("constraint_subsubtype")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_constraintfile + ".getConstraintSubsubtype(val_name);\n\n");
					...
					if (attr_name_lower.equals("spectrometer_frequency_1h") && class_name.equalsIgnoreCase("CouplingConstantList")) {
						...
						filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_couplingconstantlist + ".getSpectrometerFrequency1H(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("DataSet")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_dataset + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Datum")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_datum + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("Entity")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("polymer_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getPolymerType(val_name);\n\n");
						...
						if (attr_name_lower.equals("thiol_state")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getThiolState(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_conformational_states")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getAmbiguousConformationalStates(val_name);\n\n");
						...
						if (attr_name_lower.equals("ambiguous_chem_comp_sites")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getAmbiguousChemCompSites(val_name);\n\n");
						...
						if (attr_name_lower.equals("nstd_chirality")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getNstdChirality(val_name);\n\n");
						...
						if (attr_name_lower.equals("nstd_linkage")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getNstdLinkage(val_name);\n\n");
						...
						if (attr_name_lower.equals("paramagnetic")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entity + ".getParamagnetic(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityAssembly")) {
						...
						if (attr_name_lower.equals("physical_state")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entityassembly + ".getPhysicalState(val_name);\n\n");
						...
						if (attr_name_lower.equals("conformational_isomer")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entityassembly + ".getConformationalIsomer(val_name);\n\n");
					...
					if (attr_name_lower.equals("value_order") && class_name.equalsIgnoreCase("EntityBond")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitybond + ".getValueOrder(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityDbLink")) {
						...
						if (attr_name_lower.equals("entry_experimental_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".getEntryExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("author_supplied")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entitydblink + ".getAuthorSupplied(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntityNaturalSrc")) {
						...
						if (attr_name_lower.equals("superkingdom")) {
							...
							filew.write("\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getSuperkingdom(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
						...
						if (attr_name_lower.equals("kingdom")) {
							...
							filew.write("\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_tax + ".getKingdom(val_name, conn_tax, ncbi_taxonomy_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("Entry")) {
						...
						if (attr_name_lower.equals("experimental_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = ent.getExperimentalMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("experimental_method_subtype")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = ent.getExperimentalMethodSubtype(val_name, entry_id);\n\n");
						...
						if (attr_name_lower.equals("version_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = ent.getVersionType(val_name);\n\n");
						...
						if (attr_name_lower.equals("nmr_star_version")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = ent.getNMRStarVersion(val_name);\n\n");
						...
						if (attr_name_lower.equals("original_nmr_star_version")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = ent.getOriginalNMRStarVersion(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("EntryExperimentalMethods")) {
						...
						if (attr_name_lower.equals("subtype")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_entryexperimentalmethods + ".getSubtype(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT1List")) {
						...
						if (attr_name_lower.equals("t1_val_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt1list + ".getT1ValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t1_coherence_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt1list + ".getT1CoherenceType(val_name, entry_id);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT2List")) {
						...
						if (attr_name_lower.equals("t2_val_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt2list + ".getT2ValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t2_coherence_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt2list + ".getT2CoherenceType(val_name, entry_id);\n\n");
						...
						if (attr_name_lower.equals("rex_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt2list + ".getRexUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("temp_calibration_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt2list + ".getTempCalibrationMethod(val_name);\n\n");
						...
						if (attr_name_lower.equals("temp_control_method")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt2list + ".getTempControlMethod(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("HeteronuclT1RhoList")) {
						...
						if (attr_name_lower.equals("rex_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt1rholist + ".getRexUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("t1rho_coherence_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclt1rholist + ".getT1RhoCoherenceType(val_name);\n\n");
					...
					if (attr_name_lower.equals("heteronuclear_noe_val_type") && class_name.equalsIgnoreCase("HeteronuclNOEList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_heteronuclnoelist + ".getHeteronuclearNOEValType(val_name);\n\n");
					...
					if (attr_name_lower.equals("homonuclear_noe_val_type") && class_name.equalsIgnoreCase("HomonuclNOEList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_homonuclnoelist + ".getHomonuclearNOEValType(val_name);\n\n");
					...
					if (attr_name_lower.equals("val_units") && class_name.equalsIgnoreCase("HExchRateList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_hexchratelist + ".getValUnits(val_name);\n\n");
					...
					if (attr_name_lower.equals("constraint_type") && class_name.equalsIgnoreCase("GenDistConstraintList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_gendistconstraintlist + ".getConstraintType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("NMRExperimentFile")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrexperimentfile + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("NMRProbe")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrprobe + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("NMRSpecExpt")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspecexpt + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("nmr_tube_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspecexpt + ".getNMRTubeType(val_name);\n\n");
					...
					if (attr_name_lower.equals("manufacturer")) {
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometer")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspectrometer + ".getManufacturer(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerProbe")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspectrometerprobe + ".getManufacturer(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerView")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspectrometerview + ".getManufacturer(val_name);\n\n");
					...
					if (attr_name_lower.equals("field_strength")) {
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometer")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspectrometer + ".getFieldStrength(val_name);\n\n");
						...
						if (class_name.equalsIgnoreCase("NMRSpectrometerView")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_nmrspectrometerview + ".getFieldStrength(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("OrderParameterList")) {
						...
						if (attr_name_lower.equals("model_fit")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_orderparameterlist + ".getModelFit(val_name);\n\n");
						...
						if (attr_name_lower.equals("tau_e_val_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_orderparameterlist + ".getTauEValUnits(val_name);\n\n");
						...
						if (attr_name_lower.equals("rex_val_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_orderparameterlist + ".getRexValUnits(val_name);\n\n");
					...
					if (attr_name_lower.equals("expt_observed_param") && class_name.equalsIgnoreCase("PHTitrationList")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_phtitrationlist + ".getExptObservedParam(val_name);\n\n");
					...
					if (attr_name_lower.equals("database_name") && class_name.equalsIgnoreCase("RelatedEntries")) {
						...
						filew.write("\t\tif (val_name != null || accession_code != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_relatedentries + ".getDatabaseName(val_name, conn_bmrb, accession_code);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Release")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_release + ".getType(val_name);\n\n");
					...
					if (attr_name_lower.equals("refine_method") && class_name.equalsIgnoreCase("RepConfRefinement")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_repconfrefinement + ".getRefineMethod(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Sample")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sample + ".getType(val_name);\n\n");

						filew.write("\t\tif (val_name != null && val_name.equals(\"gel\"))\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sample + ".getGelType(val_name, conn_bmrb, entry_id);\n\n");
					...
					if (attr_name_lower.equals("concentration_val_units") && class_name.equalsIgnoreCase("SampleComponent")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_samplecomponent + ".getConcentrationValUnits(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SampleConditionVariable")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sampleconditionvariable + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("val_units")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sampleconditionvariable + ".getValUnits(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SGProject")) {
						...
						if (attr_name_lower.equals("full_name_of_center")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sgproject + ".getFullNameOfCenter(val_name);\n\n");
						...
						if (attr_name_lower.equals("initial_of_center")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sgproject + ".getInitialOfCenter(val_name);\n\n");
						...
						if (attr_name_lower.equals("project_name")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_sgproject + ".getProjectName(val_name);\n\n");
					...
					if (attr_name_lower.equals("edge_designation") && class_name.equalsIgnoreCase("StructAnnoChar")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_structannochar + ".getEdgeDesignation(val_name);\n\n");
					...
					if (attr_name_lower.equals("type") && class_name.equalsIgnoreCase("Study")) {
						...
						filew.write("\t\tif (val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_study + ".getType(val_name);\n\n");
					...
					if (class_name.equalsIgnoreCase("SystematicChemShiftOffset")) {
						...
						if (attr_name_lower.equals("type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_systematicchemshiftoffset + ".getType(val_name);\n\n");
						...
						if (attr_name_lower.equals("atom_type")) {
							...
							filew.write("\t\tif (val_name != null)\n");
							filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_systematicchemshiftoffset + ".getAtomType(val_name);\n\n");
			...
			if (attr_name.equalsIgnoreCase(column_name)) {
				...
				try {
					...
					if (attr_name_lower.equals("ambiguity_code") && class_name.equalsIgnoreCase("AtomChemShift")) {
						...
						filew.write("\t\tif (" + file_prefix + "_" + BMRxTool_DOM.util_main + ".remediate_xml && val_name != null)\n");
						filew.write("\t\t\tval_name = " + file_prefix + "_" + BMRxTool_DOM.util_atomchemshift + ".getAmbiguityCode(val_name, entry_id);\n\n");
	...
	private static void write_remed_bmrb_code(FileWriter filew, String method_name) throws IOException {
		...
		filew.write("\t\t\t\t\tif (!(" + empty_check("bmrb_code") + ") && (" + empty_check("bmrb_code") + " || !bmrb_code.equals(_bmrb_code)))\n");
	...
	private static void write_remed_pdb_code(FileWriter filew, String method_name) throws IOException {
		...
		filew.write("\t\t\t\t\tif (!(" + empty_check("pdb_code") + ") && (" + empty_check("pdb_code") + " || !pdb_code.equals(_pdb_code)))\n");
	...
	private static void write_invoke_string_method_with_nil(FileWriter filew) throws IOException {
