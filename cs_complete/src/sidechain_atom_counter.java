...
public class sidechain_atom_counter {
	...
	sidechain_atom_counter(boolean has_1h, boolean has_13c, boolean has_15n) {
	...
	public static sidechain_atom_counter set(sidechain_atom[] atoms, boolean has_1h, boolean has_13c, boolean has_15n) {

		sidechain_atom_counter counter = new sidechain_atom_counter(has_1h, has_13c, has_15n);

		if (has_1h) {

			counter.total_1h = sidechain_atom.total(atoms, atom_types.H);
			counter.total_all += counter.total_1h;
			counter.found_1h = sidechain_atom.found(atoms, atom_types.H);
		...
		if (has_13c) {
			...
			counter.total_13c = sidechain_atom.total(atoms, atom_types.C);
			counter.total_all += counter.total_13c;
			counter.found_13c = sidechain_atom.found(atoms, atom_types.C);
		...
		if (has_15n) {
			...
			counter.total_15n = sidechain_atom.total(atoms, atom_types.N);
			counter.total_all += counter.total_15n;
			counter.found_15n = sidechain_atom.found(atoms, atom_types.N);
	...
	public void add(sidechain_atom_counter atom_counter) {
