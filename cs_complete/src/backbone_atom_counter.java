...
public class backbone_atom_counter {
	...
	backbone_atom_counter(boolean has_1h, boolean has_13c, boolean has_15n, boolean has_31p) {
	...
	public static backbone_atom_counter set(backbone_atom[] atoms, boolean has_1h, boolean has_13c, boolean has_15n, boolean has_31p) {

		backbone_atom_counter counter = new backbone_atom_counter(has_1h, has_13c, has_15n, has_31p);

		if (has_1h) {

			counter.total_1h = backbone_atom.total(atoms, atom_types.H);
			counter.total_all += counter.total_1h;
			counter.found_1h = backbone_atom.found(atoms, atom_types.H);
		...
		if (has_13c) {
			...
			counter.total_13c = backbone_atom.total(atoms, atom_types.C);
			counter.total_all += counter.total_13c;
			counter.found_13c = backbone_atom.found(atoms, atom_types.C);
		...
		if (has_15n) {
			...
			counter.total_15n = backbone_atom.total(atoms, atom_types.N);
			counter.total_all += counter.total_15n;
			counter.found_15n = backbone_atom.found(atoms, atom_types.N);
		...
		if (has_31p) {
			...
			counter.total_31p = backbone_atom.total(atoms, atom_types.P);
			counter.total_all += counter.total_31p;
			counter.found_31p = backbone_atom.found(atoms, atom_types.P);
	...
	public void add(backbone_atom_counter atom_counter) {
