...
public final class ASCII_CharStream {
	...
	public ASCII_CharStream(java.io.InputStream dstream, int startline, int startcolumn, int buffersize) {
		...
		try {
			...
			inputStream = new java.io.InputStreamReader(dstream, "ISO-8859-1");

		} catch (java.io.UnsupportedEncodingException e) {
			System.err.println("ISO-8859-1 encoding not recognized.");
		}
	...
	static public void ReInit(java.io.InputStream dstream, int startline, int startcolumn, int buffersize) {
		...
		try {
			ReInit(new java.io.InputStreamReader(dstream, "ISO-8859-1"), startline, startcolumn, 4096);
		} catch (java.io.UnsupportedEncodingException e) {
			System.err.println("ISO-8859-1 encoding not recognized.");
		}
